...
public class recoverBST {
    ...
    public static void recoverTree(TreeNode root) {
        //Write code here
		/*
  Time complexity: O(n),we're visiting all the nodes once
  SC: O(log(n)), because in the stack we will having the height of the tree, not the 
  ...
  */
		...
		TreeNode prev = null;
		TreeNode curr = getNextInorder(st);//2
